                        ...
                        <div class="row">
                            <div class="col-lg-6 col-md-12 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="fee_id" value="{{$fee->fees_id}}" placeholder="Enter fee id" required>
                                </div>
                            </div>
                            <div class="col-lg-6 col-md-12 col-sm-12">
                                <div class="form-group">
                                    <label for="fee_name">Fee name <span class="text-danger">*</span></label>
                                    <input type="text" class="form-control" value="{{$fee->name}}" id="fee_name" placeholder="Enter fee name" required>
                                </div>
                            </div>
                            <div class="col-lg-6 col-md-12 col-sm-12">
                                <div class="form-group">
                                    <label for="fee_description">Fee Description <span class="text-danger">*</span></label>
                                    <input type="text" class="form-control" id="fee_description" value="{{$fee->description}}" placeholder="Enter internal fee description" required>
                                </div>
                            </div>
                            <div class="col-lg-6 col-md-12 col-sm-12">
                                <div class="form-group">
                                    <label for="fee_detail_description">Fee Detailed Description <span class="text-danger">*</span></label>
                                    <input type="text" class="form-control" id="fee_detail_description" value="{{$fee->detailed_description}}" placeholder="Enter detailed fee description" required>
                                </div>
                            </div>
                            <div class="col-lg-6 col-md-12 col-sm-12">
                                <div class="form-group">
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <select name="fee_type" id="fee_type" class="form-control">
                                        ...
                                        <option value="{{$t->id}}" {{$fee->transaction_id === $t->id? 'selected': ''}}>{{$t->name}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            <div class="col-lg-6 col-md-6 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <select name="payer" id="payer" class="form-control">
                                        ...
                                        <option value="user" {{$fee->payer === 'user'? 'selected': ''}}>User</option>
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <select name="unit_of_measure" id="unit_of_measure" class="form-control">
                                        ...
                                        <option value="per_transaction" {{$fee->unit_of_measure === 'per_transaction'? 'selected': ''}}>Per Transaction</option>
                                        <option value="per_month" {{$fee->unit_of_measure === 'per_month'? 'selected': ''}}>Per Month</option>
                                    </select>
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group row {{$fee->payer !== 'split'? 'd-none': ''}} " id="split_payer">
                                    <div class="col-lg-6 col-md-6 col-sm-12">
                                        ...
                                        <input type="text" class="form-control" value="{{$fee->sender_pay}}" name="sender_pay" id="sender_pay" oninput="divideSplitPay(this, 'sender')" placeholder="Enter sender percentage">
                                    </div>
                                    <div class="col-lg-6 col-md-6 col-sm-12">
                                        <label for="receiver_pay">Receiver Pay <span class="text-danger">*</span></label>
                                        <input type="text" class="form-control" value="{{$fee->receiver_pay}}" name="receiver_pay" id="receiver_pay" oninput="divideSplitPay(this, 'receiver')" placeholder="Enter receiver percentage">
                                    </div>
                                </div>
                            </div>
                        </div>
...
<script>
    ...
    $('#saveForm').click(function() {
        const url = '{{ route("fees-catalog.update", $id)}}';
        ...
        $.ajax({
            ...
            success:function(response){
                toastr.success('Fees catalog updated successfully!')
                window.location.href = '{{ route("fees-catalog.index") }}';
            },
